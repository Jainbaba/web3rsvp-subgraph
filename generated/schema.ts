...
export class Event extends Entity {
  ...
  get totalConfirmedAttendee(): BigInt {
    let value = this.get("totalConfirmedAttendee");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set totalConfirmedAttendee(value: BigInt) {
    this.set("totalConfirmedAttendee", Value.fromBigInt(value));
  }
